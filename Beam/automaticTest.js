...
*/
  ...
  //Test_14
  //Пример странные графики, видимо, ошибка округления 
  /*
  beamLength.value = 2450;
  beamLengthOkBtn.click();
  ...
  addSupportBtn.click();
  supportPosition.value = 0.27;
  supportType.selectedIndex = 0;
  supportPositionOkBtn.click();

  addSupportBtn.click();
  supportPosition.value = 0.59;
  supportType.selectedIndex = 0;
  supportPositionOkBtn.click();

  addSupportBtn.click();
  supportPosition.value = 0.8;
  supportType.selectedIndex = 0;
  supportPositionOkBtn.click();
...
*/
  //Test_15
  //Пример странные графики, видимо, ошибка округления 
  //Например, на опорах получился прогиб
  beamLength.value = 1200;
  beamLengthOkBtn.click();
  ...
  addSupportBtn.click();
  supportPosition.value = 0.32;
  supportType.selectedIndex = 0;
  supportPositionOkBtn.click();

  addSupportBtn.click();
  supportPosition.value = 0.69;
  supportType.selectedIndex = 0;
  supportPositionOkBtn.click();
